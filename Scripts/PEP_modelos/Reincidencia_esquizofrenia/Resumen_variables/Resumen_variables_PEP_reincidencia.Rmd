...
Para anializar la reincidencia, solo tendría sentido analoizar los casos en la base de datos que sean casos, no nos sirven de nada los controles en este caso. 
Los filtraremos
